...
const HintModal = ({ visible, onClose, onModalHide, hintText }: HintModalProps) => {
  ...
  return (
    <Modal
      ...
      <View className="flex-1 justify-center bg-black/50">
        ...
        <View className="mx-4 overflow-hidden rounded-2xl" style={{ height: screenHeight * 0.3 }}>
          <ImageBackground source={paperTexture} className="flex-1">
            ...
            <View className="flex-1 px-4 pb-4">
              <Text className="font-pixelify text-base leading-6 text-amber-900">{hintText}</Text>
            </View>
          </ImageBackground>
        </View>
      </View>
